...
def park():
    ...
    print("Pick between these options: 1.Speak with injured citizens to find out what happened, 2.Speak with the authorities, 3. Find evidence")
    chosenpath = 0
    while chosenpath == "0":
    ...
    if choice == "1":
        print("You walk up to a civilian and ask them about the blast.")
