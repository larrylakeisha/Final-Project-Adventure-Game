...
def protectworld():
    ...
    powerbar = print("Your powers are now at 100%")
    successdefeat = input("Do you want to use your powers now Y/N")
    if successdefeat == "Y":
    ...
    defeatvillain = input("Would you like to speak with the villain more or defeat him? Pick 1 or 2")
    if defeatvillain == "1":
